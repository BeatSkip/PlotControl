...
namespace GcodeParse
{
    public static class Transformations
    {
        ...
        public static SKPoint RotatePoint(SKPoint point, float degrees)
        {
            ...
            return new SKPoint((float)((point.X * Math.Cos(degrees)) - (point.Y * Math.Sin(degrees))), (float)((point.X * Math.Sin(degrees)) - (point.Y * Math.Cos(degrees))));
        }
        ...
        public static SKPoint GetTransformedToBoard(WhiteBoard v,SKPoint point, SKPoint zero, float scale, float rotation)
        {
            var pointinverted = RotateDegrees(InvertXY(point), rotation);
